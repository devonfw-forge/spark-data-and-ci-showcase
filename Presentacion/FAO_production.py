...
class FAO_production():
    ...
    def plot_production_sum(self):
        ...
        plt.ylabel('world food production (1000t)')
        plt.title('World food production by years')
        plt.show()
    ...
    def plot_zones_production(self):
        ...
        fig.update_layout(title_text='World food production by zones',xaxis_title_text="Total food production by zones",yaxis_title_text="time (years)", barmode='stack')
        fig.show()
    ...
    def plot_production_world(self,year):
        ...
        fig.update_layout(
                title = 'Food production by countries in {}'.format(year),
                geo = dict(
                    scope='world',
